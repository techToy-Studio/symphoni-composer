...
const config: Config = {
  ...
  tagline: 'Create magical rhythm experiences',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://techToy-Studio.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/symphoni-composer/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/techToy-Studio/symphoni-composer/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    image: 'img/symphoni-social-card.jpg',
    navbar: {
      title: 'Symphoni Composer',
      logo: {
        alt: 'Symphoni Logo',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Symphoni. Built with Docusaurus.`,
    },
    prism: {
